...
from src.models import GumbelNormalEncoder, GumbelNormalDecoder, gumbel_normal_vfe,\
    nll
...
def init(data, params):
    ...
    encoder = GumbelNormalEncoder(params)
    decoder = GumbelNormalDecoder(params)
...
def main(params):
    ...
    assert params.prior.lower() in ['rnn', 'tcn'], \
    ...
    if params.train:
        train(train_sequences, valid_sequences, encoder, decoder, gumbel_normal_vfe, params)
    ...
    if params.infer:
        ...
        infer(test_sequences, encoder, decoder, gumbel_normal_vfe, nll, params)
